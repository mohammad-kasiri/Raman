@extends('admin.layout.master' , ['title' => 'لیست نشست های بیمار'])
@section('title' , 'لیست نشست های بیمار')

@section('subheader')
    @can('patients.create')
        @php
            $buttons = [
                ['title' => 'مشاهده بیمار' , 'icon' => '<i class="fas fa-undo icon-nm"></i>' , 'route' => route('admin.patients.show' , $patient->id) ],
            ];
        @endphp
    @endcan
    <x-dashboard.subheader :links='$buttons ?? []' :title="'لیست نشست های بیمار'" />
@endsection
